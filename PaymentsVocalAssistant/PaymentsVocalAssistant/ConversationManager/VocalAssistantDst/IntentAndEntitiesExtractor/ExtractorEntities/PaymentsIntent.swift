...
struct PaymentsIntent: CustomStringConvertible {
    ...
    var isSomeOperationIntent: Bool {
        return self.type != .none && self.type != .no && self.type != .yes
    }
 ...
 */
public enum PaymentsIntentType: String, CaseIterable, CustomStringConvertible {
    case none              = "none"                 // 0
