 ...
 */
internal class BertIntentAndEntitiesExtractor: IntentAndEntitiesExtractor {
     ...
     */
    func recognize(from transcript: String) -> VocalAssistantDstResult<IntentAndEntitiesPrediction> {
